...
def test_recursive_improvement():
    ...
    print(f"Initial consciousness: RC={consciousness.rc_total:.3f}, Curvature={consciousness.curvature:.1f}")
    ...
    for point in trajectory:
        ...
        print(f"Step {point['iteration']}: Difficulty={point['difficulty']}, "
