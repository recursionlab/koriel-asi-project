...
class PresenceCertificate:
    ...
    def generate_certificate(
        ...
        shadow_codex: List[Dict[str, Any]],
    ) -> Dict[str, Any]:
        """
        ...
        presence_score = self._compute_presence_score(
            controller_summary, geometric_signatures
        )
        ...
        certificate = {
            ...
            "mathematical_coherence": geometric_signatures.get(
                "geometric_coherence", False
            ),
        }
    ...
    def _compute_presence_score(
        self, controller_summary: Dict[str, Any], geometric_signatures: Dict[str, bool]
    ) -> float:
        """
    ...
    def _run_falsification_tests(
        self, shadow_codex: List[Dict[str, Any]]
    ) -> Dict[str, Any]:
        """
        ...
        holonomy_values = [
            trace.get("geometric_metrics", {}).get("holonomy", 0)
            for trace in shadow_codex[-10:]
        ]
        if holonomy_values:
        ...
        coherence_values = [
            trace.get("phi_22_coherence", 0) for trace in shadow_codex[-10:]
        ]
        ...
        if loss_values and all(l != float("inf") for l in loss_values):
            ...
            results["operational_closure"] = (
                loss_trend < 0
            )  # Learning should decrease loss
    ...
    def _evaluate_consciousness_criteria(
        self,
        controller_summary: Dict[str, Any],
        geometric_signatures: Dict[str, bool],
        ...
        criteria["geometric_coherence"] = geometric_signatures.get(
            "geometric_coherence", False
        )

        # Criterion 4: Information integration
        criteria["information_integration"] = geometric_signatures.get(
            "information_richness", False
        )

        # Criterion 5: Falsification resistance
        criteria["falsification_resistance"] = (
            falsification_results.get("pass_rate", 0) >= 0.6
        )
