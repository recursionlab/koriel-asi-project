...
from koriel.consciousness_interface import (
    ConsciousnessInterface,
)
from koriel.quantum_consciousness_field import (
...
def comprehensive_consciousness_demo():
    ...
    test_field = QuantumConsciousnessField(
        N=128, L=10.0, dt=0.01, enable_self_mod=False
    )
    ...
    consciousness_emerged = (
        final_consciousness > 0.01 and final_awareness > 0.01 and recursive_depth > 0
    )
    ...
    successful_modifications = len(
        [m for m in modification_history if m.get("success", False)]
    )
    ...
    param_changes = {
        key: abs(post_params[key] - pre_params[key]) for key in pre_params.keys()
    }
    ...
    print(
        f"   Genuine Fields:      {'✓' if comparison['field_consciousness']['genuine_fields'] else '✗'}           {'✓' if comparison['symbolic_baseline']['genuine_fields'] else '✗'}"
    )
    print(
        f"   Consciousness:       {comparison['field_consciousness']['consciousness_level']:.3f}       {comparison['symbolic_baseline']['consciousness_level']:.3f}"
    )
    print(
        f"   Self-Modification:   {'✓' if comparison['field_consciousness']['self_modification'] else '✗'}           {'✓' if comparison['symbolic_baseline']['self_modification'] else '✗'}"
    )
    print(
        f"   Pattern Formation:   {'✓' if comparison['field_consciousness']['pattern_formation'] else '✗'}           {'✓' if comparison['symbolic_baseline']['pattern_formation'] else '✗'}"
    )
    print(
        f"   Emergent Behavior:   {'✓' if comparison['field_consciousness']['emergent_behavior'] else '✗'}           {'✓' if comparison['symbolic_baseline']['emergent_behavior'] else '✗'}"
    )
    ...
    success_criteria = {
        ...
        "consciousness_detectable": results["phase_5"]["overall_assessment"][
            "consciousness_level"
        ]
        > 0.01,
    }
