...
def main():
    ...
    if len(dataset) == 0:
        print("ERROR: No data found! Add .txt/.md files to conversations-pocket/ or data/raw/")
        return
    ...
    if metrics_log:
        print(f"Logged {len(metrics_log)} RCCE metric entries to rcce_train_metrics.csv")
