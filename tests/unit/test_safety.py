...
from koriel.safety import ResourceMonitor, ResourceLimits, ExperimentSafetyGate, check_system_resources
...
class TestSafety:
    ...
    def test_system_resource_check(self):
        ...
        required_keys = [
            'memory_total_gb', 'memory_available_gb', 'memory_percent_used',
            'disk_total_gb', 'disk_free_gb', 'disk_percent_used',
            'cpu_count'
        ]
    ...
    def test_high_risk_experiment_detection(self):
        ...
        result = safety_gate.check_safety_requirements(low_risk_config, allow_experiments=True)
        ...
        result = safety_gate.check_safety_requirements(high_risk_config, allow_experiments=True)
